...
Usage: python scripts/research/compare_hedged_unhedged.py configs/backtest/naked_call_usd.yaml
"""
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python scripts/research/compare_hedged_unhedged.py <config.yaml>")
        raise SystemExit(1)
    main(sys.argv[1])
