...
用法:
    python scripts/data/cdd_download_0dte.py                # BTC 全量
    python scripts/data/cdd_download_0dte.py --year 2024    # 只下 2024
    python scripts/data/cdd_download_0dte.py --test         # 测试 3 个日期
"""
