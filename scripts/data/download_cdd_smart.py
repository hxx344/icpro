...
Usage:
    python scripts/data/download_cdd_smart.py                 # All missing BTC
    python scripts/data/download_cdd_smart.py --year 2024     # Just 2024
    python scripts/data/download_cdd_smart.py --currency ETH  # ETH options
    python scripts/data/download_cdd_smart.py --status        # Show progress
"""
...
INST_DIR = Path(__file__).resolve().parents[2] / "data" / "instruments"
