...
print("BTC 0DTE ATM Iron Condor - Wing Width Comparison")
...
for wing in WINGS:
    ...
    cfg.backtest.name = f"BTC 0DTE ATM Wing={wing*100:.0f}%"
...
cfg.strategy.params["stop_loss_pct"] = 9999
cfg.strategy.params["max_positions"] = 1
cfg.backtest.name = "BTC 0DTE ATM naked"
s = _load_strategy(cfg.strategy.name, cfg.strategy.params)
e = BacktestEngine(cfg, s)
t0 = time.perf_counter()
r = e.run()
