...
Usage:
    python scripts/download_cdd_data.py [--currency BTC] [--years 2021,2022,2023,2024,2025]
    python scripts/download_cdd_data.py --currency BTC --years 2024 --concurrency 10
    python scripts/download_cdd_data.py --all  # Download BTC+ETH, all years
"""
